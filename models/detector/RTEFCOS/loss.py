...
from utils.misc import sigmoid_focal_loss, varifocal_loss
...
class Criterion(object):
    ...
    def loss_labels(self, pred_cls, tgt_cls, num_boxes=1.0):
        ...
        """
        # cls loss: [V, C]
        loss_cls = varifocal_loss(pred_cls, tgt_cls,None, self.alpha, self.gamma, reduction='none')

        return loss_cls.sum() / num_boxes

    def loss_bboxes(self, pred_delta, tgt_delta, iou_type='giou', bbox_quality=None, num_boxes=1.0):
        """
            pred_box: (Tensor) [N, 4]
            tgt_box:  (Tensor) [N, 4]
        """
        ...
        # siou
        if iou_type == 'siou':
            b1_x1, b1_y1, b1_x2, b1_y2 = pred_delta[..., 0], pred_delta[..., 1], pred_delta[..., 2], pred_delta[..., 3]
            b2_x1, b2_y1, b2_x2, b2_y2 = tgt_delta[..., 0], tgt_delta[..., 1], tgt_delta[..., 2], tgt_delta[..., 3]
            # Intersection area
