...
def coco2voc(anno, xml_dir):
    ...
    for i in tqdm(range(len(imgs))):
        ...
        xml_path = os.path.join(xml_dir, file_name.split('.')[0] + '.02.xml')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path', type=str, help='path to json file.', default="./data/foggy_cityscapes/annotations/instances_foggy_train.json")
    parser.add_argument('--output', type=str, help='path to output xml files.', default="./target_train_xml")
